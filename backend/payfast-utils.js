/**
 * PayFast Payment Gateway Utilities - Backend (Server-side)
 * 
...
async function getPayFastToken(data) {
  ...
  if (!merchantId || !securedKey || !tokenApiUrl) {
    throw new Error('PayFast credentials not configured. Please set PAYFAST_MERCHANT_ID, PAYFAST_SECURED_KEY, and PAYFAST_TOKEN_API_URL');
  }
