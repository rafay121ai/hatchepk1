...
function Affiliate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Convert commission from "5%" to decimal 5.00
      const commissionDecimal = parseFloat(tierInfo.commission.replace('%', ''));
        ...
        .insert([
          {
            ...
            tier: formData.tier,
            tier_name: tierInfo.name,
            commission: commissionDecimal, // Store as decimal instead of text
            email: formData.email,
            instagram_username: formData.instagramUsername,
            ...
            ref_id: null // Will be generated by trigger when approved
          },
        ]);
